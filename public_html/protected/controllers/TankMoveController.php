...
class TankMoveController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['TankMove']))
		{
			$model->attributes=$_POST['TankMove'];
			if($model->save())
	...
	{
		$model=new TankMove('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['TankMove']))
			$model->attributes=$_GET['TankMove'];
		else {
	 ...
	 * @return TankMove the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TankMove::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TankMove $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tank-move-form')
		{
