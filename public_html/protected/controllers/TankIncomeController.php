...
class TankIncomeController extends Controller
{
	/**
...
//			'postOnly + delete', // we only allow deletion via POST request
	...
	public function actionCreate()
	{
		...
		$model=new TankIncome;
		$model->scenario = 'modify';
		
		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['TankIncome']))
		{
			$model->attributes=$_POST['TankIncome'];
			if($model->save())
	...
	{
		$model=new TankIncome('search');			
		$model->unsetAttributes(); 
		if(isset($_GET['TankIncome']))
			$model->attributes=$_GET['TankIncome'];
		else {
	 ...
	 * @return TankIncome the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=TankIncome::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param TankIncome $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tank-income-form')
		{
