	...
	<table>
		<tbody>
			...
			<tr>
				...
				<td><?php echo $form->textField($model,'sn',array('class' => 'numeric-editor','maxlength'=>10)); ?></td>
			</tr>
			...
			<tr>
				...
				<td><?php echo $form->dropDownList($model,'active', array(1 => 'Да', 0 => 'Нет',), array('class' => 'str-editor') );	?></td>
			</tr>
			
			<tr>
				<td><?php echo $form->labelEx($model,'transNo'); ?></td>
				<td><?php echo $form->textField($model,'transNo',array('class' => 'numeric-editor','maxlength'=>10)); ?></td>
			</tr>
			
			<tr>
				<td><?php echo $form->labelEx($model,'eventNo'); ?></td>
				<td><?php echo $form->textField($model,'eventNo',array('class' => 'numeric-editor','maxlength'=>10)); ?></td>
			</tr>			
